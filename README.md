XenHid - The XenServer Paravitual HID Driver for Windows
==================================================================

The XenHid package consists of a single device driver:

*    xenhid.sys is a HID miniport driver which attaches to a virtual device created
     by XenBus (see https://github.com/xenserver/win-xenbus) and exposes top-level 
	 HID collections for the defined protocol. The default protocol exposes an 
	 absolute mouse and a keyboard.
